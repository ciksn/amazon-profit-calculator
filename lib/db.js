...
CREATE TABLE IF NOT EXISTS project_competitors (
  ...
  monthly_revenue_usd DOUBLE PRECISION NOT NULL DEFAULT 0, rating DOUBLE PRECISION, review_count DOUBLE PRECISION NOT NULL DEFAULT 0,
  competitor_kind TEXT NOT NULL DEFAULT 'standard',
  ...
  review_analysis_model TEXT NOT NULL DEFAULT '', review_analysis_at TEXT NOT NULL DEFAULT '',
  created_at TEXT NOT NULL, updated_at TEXT NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_project_competitors_project ON project_competitors(project_id,country_code,id);
CREATE TABLE IF NOT EXISTS competitor_review_overviews (
  project_id INTEGER NOT NULL REFERENCES projects(id) ON DELETE CASCADE,
  ...
  status TEXT NOT NULL DEFAULT '', analysis_model TEXT NOT NULL DEFAULT '',
  analysis_at TEXT NOT NULL DEFAULT '', updated_at TEXT NOT NULL DEFAULT '',
  PRIMARY KEY(project_id,country_code,competitor_kind)
);
...
CREATE TABLE IF NOT EXISTS selection_documents (
  ...
  decision_status TEXT NOT NULL DEFAULT '观察中', decision_reason TEXT NOT NULL DEFAULT '',
  positioning TEXT NOT NULL DEFAULT '', use_scenarios TEXT NOT NULL DEFAULT '',
  competitive_points TEXT NOT NULL DEFAULT '', differentiation_items JSONB NOT NULL DEFAULT '[]'::jsonb,
  review_issues JSONB NOT NULL DEFAULT '[]'::jsonb, overview_summary TEXT NOT NULL DEFAULT '',
  competitor_summary TEXT NOT NULL DEFAULT '', supplier_summary TEXT NOT NULL DEFAULT '',
  patent_notes TEXT NOT NULL DEFAULT '', checklist JSONB NOT NULL DEFAULT '[]'::jsonb,
  version INTEGER NOT NULL DEFAULT 0, updated_at TEXT NOT NULL DEFAULT ''
);
CREATE TABLE IF NOT EXISTS selection_site_assessments (
  project_id INTEGER NOT NULL REFERENCES projects(id) ON DELETE CASCADE,
  country_code TEXT NOT NULL REFERENCES countries(code),
  market_average_revenue DOUBLE PRECISION NOT NULL DEFAULT 0,
  market_average_sales DOUBLE PRECISION NOT NULL DEFAULT 0,
  new_product_friendliness TEXT NOT NULL DEFAULT '', same_product_performance TEXT NOT NULL DEFAULT '',
  opportunity_status TEXT NOT NULL DEFAULT '', opportunity_notes TEXT NOT NULL DEFAULT '',
  ...
  updated_at TEXT NOT NULL DEFAULT '', PRIMARY KEY(project_id,country_code)
);
CREATE TABLE IF NOT EXISTS selection_suppliers (
  id SERIAL PRIMARY KEY, project_id INTEGER NOT NULL REFERENCES projects(id) ON DELETE CASCADE,
  ...
  specifications TEXT NOT NULL DEFAULT '', certifications TEXT NOT NULL DEFAULT '',
  sample_reason TEXT NOT NULL DEFAULT '', pre_sample_score DOUBLE PRECISION,
  post_sample_score DOUBLE PRECISION, pros TEXT NOT NULL DEFAULT '', cons TEXT NOT NULL DEFAULT '',
  target_country_code TEXT NOT NULL DEFAULT '', target_sale_price DOUBLE PRECISION NOT NULL DEFAULT 0,
  created_at TEXT NOT NULL, updated_at TEXT NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_selection_suppliers_project ON selection_suppliers(project_id,id);
...
CREATE INDEX IF NOT EXISTS idx_selection_ai_messages_summary
  ON selection_ai_messages(project_id,id);
...
async function migrateSchema(client) {
  ...
  await client.query('ALTER TABLE selection_ai_conversations ADD COLUMN IF NOT EXISTS summary_message_id BIGINT NOT NULL DEFAULT 0');
  ...
  const competitorColumns = {
    asin:"TEXT NOT NULL DEFAULT ''",image_url:"TEXT NOT NULL DEFAULT ''",product_url:"TEXT NOT NULL DEFAULT ''",
    is_fba:'INTEGER',has_aplus:'INTEGER',has_video:'INTEGER',listing_date:"TEXT NOT NULL DEFAULT ''",review_count:'DOUBLE PRECISION NOT NULL DEFAULT 0',
    competitor_kind:"TEXT NOT NULL DEFAULT 'standard'",
    monthly_sales:'DOUBLE PRECISION NOT NULL DEFAULT 0',monthly_revenue_local:'DOUBLE PRECISION NOT NULL DEFAULT 0',
