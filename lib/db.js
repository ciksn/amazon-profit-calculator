...
async function addTestOwnershipDefaults(client){
  ...
  for(const table of ['projects','project_countries','project_competitors','competitor_review_overviews','site_card_variants','site_card_variant_listings','site_card_records',
